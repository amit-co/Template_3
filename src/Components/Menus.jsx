        ...
        <div className="flex flex-col bg-cover h-full md:h-[250px] lg:h-[250px] " style={{ backgroundImage: `url(${img1})` }}>
            <div className="flex flex-col w-9/12 lg:w-8/12 mx-auto mt-6 sm:mt-6 md:mt-7 lg:mt-10">
                ...
                <div className="grid grid-cols-3 divide-x-4  text-center font-bold  text-white ">
                    <button onClick={() => navigate("/venue/cafe")} className=" text-sm sm:text-lg md:text-3xl lg:text-4xl mt-2 mb-4 md:mt-10 tracking-widest">CAFE</button>
                    <button onClick={() => navigate("/venue/bar")} className=" text-sm sm:text-lg md:text-3xl lg:text-4xl mt-2 mb-4 md:mt-10 tracking-widest">BAR</button>
                    <button onClick={() => navigate("/venue/ird")} className=" text-sm sm:text-lg md:text-3xl lg:text-4xl mt-2 mb-4 md:mt-10 tracking-widest ml-4 ">DINING</button>
                    </div>
           </div>
        </div>
    );

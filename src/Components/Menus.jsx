...
export function Menus() {
    ...
    return (
        <div className="flex flex-col bg-cover h-[250px] " style={{ backgroundImage: `url(${img1})` }}>
            <div className="flex flex-col w-11/12 lg:w-8/12 mx-auto  mt-5 sm:mt-6 md:mt-7 lg:mt-10">
                <p className="text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl  font-medium mx-auto ">Your Perfect Destination For </p>

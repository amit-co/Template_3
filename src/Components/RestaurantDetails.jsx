        ...
        <div>
            <div className=" lg:h-full mx-auto items-center lg:flex  ">
                ...
                <div className="flex flex-col px-10 w-full md:w-9/12  mt-12 lg:mt-0 mx-auto  border-[2px]">
                    ...
                    <button className="rounded-full  text-customWhite text-3xl border-customWhite border-[1px] mx-auto px-3 py-2 mb-10">Find A Table</button>
                    <h1 className="mx-auto text-6xl text-customWhite tracking-widest">What's On Menu ?</h1>
                    <div className="flex flex-row space-x-4 mt-10 mb-10">
                        <div className="relative group  overflow-hidden">
                        <img src={img1} className="mb-4 h-full transition duration-300 ease-in-out transform  hover:scale-105" />
